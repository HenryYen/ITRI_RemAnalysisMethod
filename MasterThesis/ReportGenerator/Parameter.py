...
fix_cell_pos = True 
closest_N_cell_no = 4       #there are some BS information(x,y,power) in MDT. This parameter determine the No of BSs shown in MDT.  N means the first N closest small cells to user.
...
#external data
header = ['id','location_id','user_x','user_y'] + ['cell_x', 'cell_y', 'cell_power']*closest_N_cell_no + ['serving Rx','neighbor Rx']
path = './data'
